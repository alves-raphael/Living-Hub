    ...
    return (
        <>
            ...
            <section class="bg-gray-50">
                <div class="w-full px-4 lg:flex py-32 lg:h-screen lg:items-center bg-red-100">
                    <div class="mx-auto max-w-xl text-center">
                        ...
                        <p class="mt-4 sm:text-xl/relaxed">
                            Tenha maior organização e controle no agendamento de
                            áeras comuns no seu condomínio e muito mais!
                        </p>
                        ...
                        <div class="mt-8 flex flex-wrap justify-center gap-4">
                            ...
                            <a
                                class="block w-full rounded px-12 py-3 text-sm font-medium bg-white text-red-600 shadow hover:text-red-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
                                href="/about"
                            >
                                Learn More
                            </a>
